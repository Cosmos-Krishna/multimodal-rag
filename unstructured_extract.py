...
Usage:
    ...
    python unstructured_extract.py path/to/document.pdf --output-dir comparison_output/unstructured_output

Output (under comparison_output/unstructured_output/<pdf_stem>/):
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", default="comparison_output/unstructured_output",
        help="Base output directory (default: comparison_output/unstructured_output)",
    )
